...
/* Tap-to-click: 1 = tapping the touchpad clicks */
static const int tap_to_click = 1;
/* Tap-and-drag: 1 = tap, then hold to drag */
static const int tap_and_drag = 1;
/* Drag lock: 1 = tap-and-drag locks until a second tap releases */
static const int drag_lock = 1;
/* Natural scrolling: 1 = scroll content, not view (macOS style) */
static const int natural_scrolling = 0;
/* Disable touchpad while typing: 1 = palm rejection */
static const int disable_while_typing = 1;
/* Left-handed mode: 1 = swap left/right mouse buttons */
static const int left_handed = 0;
/* Middle button emulation: 1 = simultaneous left+right click = middle click */
static const int middle_button_emulation = 0;
/* Scroll method:
 *   LIBINPUT_CONFIG_SCROLL_NO_SCROLL
 *   LIBINPUT_CONFIG_SCROLL_2FG          - two-finger scroll
 *   LIBINPUT_CONFIG_SCROLL_EDGE         - edge scrolling
...
/* Pointer sensitivity (-1.0 to 1.0). 0 = default, negative = slower, positive = faster.
 * Accel profile is hardcoded to FLAT (no acceleration curve). */
static const double accel_speed = 0.0;
/* Tap button mapping:
 *   LIBINPUT_CONFIG_TAP_MAP_LRM -- 1/2/3 fingers -> left/right/middle
 *   LIBINPUT_CONFIG_TAP_MAP_LMR -- 1/2/3 fingers -> left/middle/right
 */
...
static const Key keys[] = {
	...
	{ MODKEY,			XKB_KEY_space,		spawn,		{.v = jtsearch} },
	{ MODKEY,			XKB_KEY_v,		spawn,		{.v = jtvolume} },
